...
FEMenuSystem::FEMenuSystem(int a2, int a3) {
    if constexpr (1) {
        ...
        for (int i = 0; i < this->m_count; ++i) {
            ...
            auto *vtbl = bit_cast<thiscall_call(*)[1]>(menu->m_vtbl);
            auto func = (*vtbl)[3];
...
void FEMenuSystem::MakeActive(int idx) {
    if constexpr (1) {
        ...
        if (idx != -1) {
            ...
            auto *vtbl = bit_cast<thiscall_call(*)[1]>(v5->m_vtbl);
        ...
        if (idx >= 0) {
            ...
            auto *vtbl = bit_cast<thiscall_call(*)[1]>(v6->m_vtbl);
            auto *func = (*vtbl)[11];
    ...
    if constexpr (1) {
        ...
        if (idx >= 0) {
...

            {
                ...
                auto *field_6C = (*vtbl)[27];

                field_6C(v5, a3, a2);
            }

            auto *vtbl = bit_cast<thiscall_call(*)[1]>(this->m_vtbl);
            auto *field_34 = (*vtbl)[13];
                ...
                if (a2 > 128) {
                    if (a2 > 2048) {
                        if (a2 == 4096) {
                            ...
                            auto *vtbl = bit_cast<thiscall_call(*)[1]>(v19->m_vtbl);
                            auto *field_64 = (*vtbl)[25];
                        ...
                        case 2048: {
                            ...
                            auto *vtbl = bit_cast<thiscall_call(*)[1]>(v17->m_vtbl);
                            auto *field_60 = (*vtbl)[24];
                        ...
                        case 256: {
                            ...
                            auto *vtbl = bit_cast<thiscall_call(*)[1]>(v16->m_vtbl);
                            auto *field_54 = (*vtbl)[21];
                        ...
                        case 512: {
                            ...
                            auto *vtbl = bit_cast<thiscall_call(*)[1]>(v15->m_vtbl);
                            auto *field_58 = (*vtbl)[22];
                        ...
                        case 1024: {
                            ...
                            auto *vtbl = bit_cast<thiscall_call(*)[1]>(v14->m_vtbl);
                            auto *field_5C = (*vtbl)[23];
                    ...
                    auto *vtbl = bit_cast<thiscall_call(*)[1]>(v13->m_vtbl);
                    auto *field_50 = (*vtbl)[20];

                    field_50(v13, a3); // OnTriangle()
                } else {
                    switch (a2) {
                    case 1: {
                    ...
                    case 2: {
                        ...
                        auto *vtbl = bit_cast<thiscall_call(*)[1]>(v7->m_vtbl);
                        auto *field_38 = (*vtbl)[14];
                    ...
                    case 4: {
                        ...
                        auto *vtbl = bit_cast<thiscall_call(*)[1]>(v8->m_vtbl);
                        auto *field_3C = (*vtbl)[15];

                        field_3C(v8, a3); // character_view::onUp()
                        break;
                    }
                    case 8: {
                        auto *v9 = this->field_4[this->m_index];

                        auto *vtbl = bit_cast<thiscall_call(*)[1]>(v9->m_vtbl);
                        auto *field_40 = (*vtbl)[16];

                        field_40(v9, a3); // character_view::onDown()
                        break;
                    }
                    case 16: {
                        auto *v10 = this->field_4[this->m_index];

                        auto *vtbl = bit_cast<thiscall_call(*)[1]>(v10->m_vtbl);
                        auto *field_44 = (*vtbl)[17];
                    ...
                    case 32: {
                        ...
                        auto *vtbl = bit_cast<thiscall_call(*)[1]>(v11->m_vtbl);
                        auto *field_48 = (*vtbl)[18];
                    ...
                    case 64: {
                        ...
                        auto *vtbl = bit_cast<thiscall_call(*)[1]>(v12->m_vtbl);
                        auto *field_4C = (*vtbl)[19];
    ...
    if constexpr (1) {
        ...
        if (idx >= 0) {
            ...
            if (auto *menu = v4[idx]; menu != nullptr) {
                auto &func = get_vfunc(menu->m_vtbl, 0x70);
                func(menu, a3, a2);
...
void FEMenuSystem::UpdateButtonPresses() {
    ...
    for (const auto &v3 : this->field_18) {
        for (int i = 1; i < 16384; i *= 2) {
            auto *vtbl = bit_cast<thiscall_call(*)[16]>(this->m_vtbl);
