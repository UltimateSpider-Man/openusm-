...
struct cut_scene_resource_handler : base_engine_resource_handler {
    cut_scene_resource_handler(worldly_pack_slot *a2);
...
extern void cut_scene_resource_handler_patch();
